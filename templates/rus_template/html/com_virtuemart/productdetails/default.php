...
//Создаем 1 вкладку, например Ваше Описание товара
/*если описание товара не пустое, то создаем вкладку*/
...
// Создаем 3 вкладку для отображения коментариев JComments. Если данный компонент не установлен, установите. я использую его .Именно такая запись кода работает у меня.
...
// Создаем 2 вкладку для настраваемых полей
/*Если у Вашего товара есть настраиваемое поле, например текстовое поле, или поле картинка, то его тоже можно определить в Табы. если их нет то вкладка просто не появиться */
                if (!empty($this->product->reviews)) {
                $output .= $myTabs->startPanel( 'Рецензии', 'tab4' );
